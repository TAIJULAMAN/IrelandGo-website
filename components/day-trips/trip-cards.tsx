...
const trips = [
    ...
    },
    {
        ...
        groupSize: 'Private group',
        price: '€125',
        image: 'https://images.pexels.com/photos/14660383/pexels-photo-14660383.jpeg?auto=compress&cs=tinysrgb&w=800',
    },
    {
        id: 3,
        ...
        groupSize: 'Private group',
        price: '€135',
        image: 'https://images.pexels.com/photos/15092338/pexels-photo-15092338.jpeg?auto=compress&cs=tinysrgb&w=800',
    },
    {
        id: 4,
        ...
        groupSize: 'Private group',
        price: '€142',
        image: 'https://images.pexels.com/photos/11880886/pexels-photo-11880886.jpeg?auto=compress&cs=tinysrgb&w=800',
    },
    {
        id: 5,
        ...
        <div className="px-5 md:px-0 py-16 bg-gray-50">
            ...
            >
                <CarouselContent className="-ml-4">
                    {trips.map((trip) => (
                        <CarouselItem key={trip.id} className="pl-4 md:basis-1/2 lg:basis-1/4">
                            <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all cursor-pointer border border-gray-100">
                                ...
                                <div className="p-4">
                                    ...
                                    <p className="text-gray-900 text-sm">
                                        <span className="font-semibold">From {trip.price}</span> / per person
                                    </p>
                                </div>
                            </div>
                        </CarouselItem>
                ...
                <CarouselPrevious className="bg-blue-600 text-white hover:bg-blue-700 border-0 w-10 h-10 -left-12" />
                <CarouselNext className="bg-blue-600 text-white hover:bg-blue-700 border-0 w-10 h-10 -right-12" />
            </Carousel>
        </div>
    );
}
