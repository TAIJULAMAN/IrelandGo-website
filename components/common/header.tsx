  ...
  return (
    ...
    >
      ...
      <nav className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 hidden md:flex gap-8 text-sm text-white/90 z-10">
        <a href="/transfer" className="hover:text-white transition font-bold text-lg">Transfers</a>
        <Link href="/multi-day-tours" className="hover:text-white transition font-bold text-lg">Tours</Link>
        <Link href="/contact" className="hover:text-white transition font-bold text-lg">Contact</Link>
      </nav>
