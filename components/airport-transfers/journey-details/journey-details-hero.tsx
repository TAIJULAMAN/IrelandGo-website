...
export default function JourneyDetailsHero() {
  return (
    <section className="relative bg-linear-to-b from-blue-50/50 to-white pb-12 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-5 lg:px-0 py-10 lg:py-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-5 lg:gap-10 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg bg-white border border-gray-100 shadow-xs hover:shadow-md transition-shadow">
              ...
              <div className="p-4 rounded-lg bg-white border border-gray-100 shadow-xs hover:shadow-md transition-shadow sm:col-span-1 col-span-2">
          ...
          <div className="relative lg:h-[500px]">
            ...
            <div className="relative h-full rounded-lg overflow-hidden shadow-2xl ring-1 ring-black/5 bg-gray-100">
              <img
                src="/hero2.png"
              ...
              {/* Floating Badge */}
              <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm p-4 rounded-lg shadow-lg border border-gray-100">
