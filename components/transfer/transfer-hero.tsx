      ...
      <div className="max-w-6xl mx-auto px-5 pt-16 pb-16 flex flex-col items-center text-center gap-10">
        ...
        <div className="w-full max-w-3xl bg-white rounded-lg shadow-2xl px-4 sm:px-6 py-6 flex flex-col gap-3 text-left">
          ...
          <div className="flex flex-col sm:flex-row items-stretch gap-3">
            ...
            <Link
              href="/transfer/transfer-search"
              className="inline-flex items-center justify-center px-5 sm:px-7 py-2.5 sm:py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm sm:text-base font-semibold whitespace-nowrap shadow-md"
            >
