	...
	return (
		<section className="bg-[#111c3a] py-12 sm:py-16">
			<div className="max-w-5xl mx-auto px-5 md:px-0 text-center text-white">
				...
				<Button
					asChild
					className="inline-flex items-center gap-2 rounded-lg px-5 md:px-10 py-2.5 md:py-3 bg-white hover:bg-gray-100 text-blue-600 text-sm font-medium shadow-md"
				>
					<Link href="/contact">
