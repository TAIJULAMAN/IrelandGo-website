        ...
        <div className="container mx-auto px-5 md:px-0 lg:px-0">
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-5 sm:p-7 md:p-8">
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-7 max-w-3xl">
              Select your pickup and dropoff locations to see popular
    ...
    <section className="bg-white py-10 sm:py-16">
      <div className="container mx-auto px-5 md:px-0 lg:px-0">
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-5 sm:p-7 md:p-8">
          ...
          <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-7 max-w-3xl">
            Discover amazing attractions and landmarks in your pickup and
            dropoff locations.
            {pickupParam &&
              dropoffParam &&
              ` Traveling from ${pickupParam} to ${dropoffParam} offers unique experiences.`}
          </p>
