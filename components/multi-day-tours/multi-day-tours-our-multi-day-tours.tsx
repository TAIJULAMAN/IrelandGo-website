        ...
        {!isLoading && pagedTours.length > 0 && (
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
            {pagedTours.map((t: any) => (
              ...
              >
                <div className="bg-white/80 backdrop-blur-md rounded-xl sm:rounded-2xl overflow-hidden shadow-sm hover:shadow-xl border border-gray-100 hover:border-white transition-all duration-500 hover:-translate-y-2 flex flex-col h-full relative">
                  ...
                  <div className="relative h-28 sm:h-48 md:h-56 overflow-hidden">
                    <img
                      src={
                        t.images?.[0] ||
                    ...
                    {t.tourDays && (
                      <span className="absolute left-2 top-2 sm:left-4 sm:top-4 inline-flex items-center gap-1 px-2 sm:px-3 py-0.5 sm:py-1.5 rounded-full text-[10px] sm:text-xs font-bold bg-white/95 backdrop-blur-md text-blue-700 shadow-sm border border-white/20">
                        <Clock className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                        {t.tourDays} Day{t.tourDays > 1 ? "s" : ""}
                      </span>
                    )}
                    <span className="absolute right-2 top-2 sm:right-4 sm:top-4 inline-flex items-center gap-1 px-2 sm:px-3 py-0.5 sm:py-1.5 rounded-full bg-gray-900/80 backdrop-blur-md text-white text-[10px] sm:text-xs font-bold shadow-sm border border-white/10">
                      <Star className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-yellow-400 fill-yellow-400" />{" "}
                      {t.ratings || "5.0"}
                    </span>
                  </div>

                  <div className="p-3 sm:p-5 md:p-6 flex-1 flex flex-col relative z-10">
                    <h3 className="text-xs sm:text-lg md:text-xl font-bold text-gray-900 mb-1.5 sm:mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-indigo-600 transition-all duration-300 line-clamp-2">
                      {t.title}
                    </h3>
                    <p className="text-gray-600 text-[11px] sm:text-sm leading-relaxed mb-3 sm:mb-6 line-clamp-2 sm:line-clamp-3 flex-1 group-hover:text-gray-700 transition-colors">
                    ...
                    <div className="mt-auto">
                      ...
                      <button className="w-full px-2 sm:px-4 py-2 sm:py-3 rounded-lg sm:rounded-xl text-xs sm:text-sm font-bold bg-blue-50 text-blue-700 group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-indigo-600 group-hover:text-white transition-all duration-300 shadow-sm">
                        View Details
                      </button>
                    </div>
                  </div>
