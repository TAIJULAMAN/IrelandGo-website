        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {visibleTours.map((tour: any, idx: number) => (
            ...
            >
              ...
              <div
                className="relative h-28 sm:h-40 md:h-48 overflow-hidden bg-gray-100 z-10"
              ...
              <div className="p-3 sm:p-5 md:p-6 flex flex-col flex-1 relative z-10">
                ...
                <p className="text-[11px] sm:text-sm md:text-base text-gray-600 mb-3 sm:mb-6 line-clamp-2 sm:line-clamp-3 leading-relaxed group-hover:text-gray-700 transition-colors">
                  {stripHtml(tour.description)}
                </p>

                <div className="mt-auto">
                  <Link href={`/multi-day-tours/${tour.id}`} className="block w-full">
                    <button className="w-full px-2 sm:px-4 py-2 sm:py-3.5 rounded-lg sm:rounded-xl text-xs sm:text-sm md:text-base font-bold bg-blue-50 text-blue-700 group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-indigo-600 group-hover:text-white transition-all duration-300 shadow-sm hover:shadow-md border-none">
                      View Details
                    </button>
                  </Link>
                </div>
