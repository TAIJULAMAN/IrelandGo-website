                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="bg-white p-6 sm:p-8 lg:p-10 xl:p-12">
                            <div className="text-center lg:text-left mb-7">
                                <div className="w-14 h-14 bg-green-50 rounded-lg flex items-center justify-center mx-auto lg:mx-0 mb-4">
                                    ...
                                    <div className="flex gap-2 sm:gap-3 justify-center lg:justify-start" onPaste={handlePaste}>
                                        {code.map((digit, index) => (
                                            <input
                                                ...
                                                className={`w-11 h-13 sm:w-13 sm:h-15 text-center text-lg sm:text-xl font-bold border-2 rounded-lg outline-none transition-all ${digit
