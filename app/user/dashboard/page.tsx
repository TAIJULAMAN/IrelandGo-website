                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <Card className="text-center bg-gray-50 hover:shadow-md transition-shadow">
                        <CardHeader className="space-y-4">
                            ...
                            <CardTitle className="text-lg font-semibold text-gray-800">New Booking</CardTitle>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card className="text-center bg-gray-50 hover:shadow-md transition-shadow">
                        <CardHeader className="space-y-4">
                            ...
                            <CardTitle className="text-lg font-semibold text-gray-800">Contact Support</CardTitle>
                        </CardHeader>
                        <CardContent>
                    ...
                    <div className="p-6">
                        ...
                        <div className="space-y-6">
                            {activities.map((activity) => (
                                <div key={activity.id} className="flex items-start p-3 bg-gray-100 rounded-lg">
