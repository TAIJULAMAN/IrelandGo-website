...
import { Search, Filter, Clock, CheckCircle, XCircle, MapPin, Users, Clock as ClockIcon, Calendar, ArrowRight, MoreHorizontal, X, AlertCircle, Check, CreditCard, User, Navigation, CalendarDays, Clock9, MapPin as MapPinIcon } from 'lucide-react';
  ...
  return (
    <div className="border rounded-lg p-6 mb-6 shadow-sm hover:shadow-md transition-shadow">
      <div className="flex justify-between items-start mb-4">
        <div>
          <h3 className="font-semibold text-gray-500 text-sm">Booking ID: {id}</h3>
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div className="flex items-center">
            ...
            <span>{passengers} {passengers > 1 ? 'Passengers' : 'Passenger'}</span>
          </div>
          <div className="flex items-center">
...
export default function BookingsPage() {
      ...
      setBookings(prev => 
        prev.map(booking => 
          booking.id === selectedBookingId 
            ? { ...booking, status: 'cancelled', refundStatus: 'Refund Processed' } 
            : booking
        )
      );
  ...
  const handleRateTrip = useCallback((id: string) => {
    toast({
      title: "Rate Trip",
    ...
    <div className="flex flex-col min-h-[calc(100vh-4rem)]">
        ...
        <AlertDialogContent className="bg-white rounded-lg p-6 w-full max-w-md mx-4 sm:mx-0">
          <AlertDialogHeader className="mb-4">
            ...
            <AlertDialogDescription className="mt-2 text-gray-600">
              This action cannot be undone. You may be eligible for a refund as per our cancellation policy.
            </AlertDialogDescription>
          </AlertDialogHeader>
      ...
      <AlertDialog open={showModifyModal} onOpenChange={setShowModifyModal}>
        <AlertDialogContent className="max-w-2xl">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-2xl">Modify Booking</AlertDialogTitle>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center p-3 border rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{selectedBooking.pickupDetail}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center p-3 border rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{selectedBooking.destinationDetail}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center p-3 border rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Duration: {selectedBooking.duration}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center p-3 border rounded-lg">
                    ...
                    <div>
                      <p className="font-medium">{selectedBooking.passengers} {selectedBooking.passengers === 1 ? 'Passenger' : 'Passengers'}</p>
                      <p className="text-sm text-muted-foreground">Total: {selectedBooking.price}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-gray-500 text-sm">ID: {selectedBooking.id}</p>
                </div>
                <button 
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{selectedBooking.pickupDetail}</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{selectedBooking.destinationDetail}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{selectedBooking.passengers} {selectedBooking.passengers > 1 ? 'People' : 'Person'}</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <div className="bg-gray-100 p-2 rounded-full mr-3">
      ...
      {/* Footer */}
      <div className="w-full bg-[#0b1930] border-t border-gray-200 mt-auto">
